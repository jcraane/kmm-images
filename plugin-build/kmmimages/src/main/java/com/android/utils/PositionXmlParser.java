...
public class PositionXmlParser {
    ...
    public static Document parse( InputStream input, boolean namespaceAware)
    ...
    public static Document parse(
             InputStream input, boolean namespaceAware,  List<String> parseErrors)
    ...
    public static Document parse( byte[] data, boolean namespaceAware)
            throws ParserConfigurationException, SAXException, IOException {
    ...
    public static Document parse(
             byte[] data, boolean namespaceAware,  List<String> parseErrors)
            throws ParserConfigurationException, IOException {
        String xml = getXmlString(data);
        xml = XmlUtils.stripBom(xml);
    ...
    private static Document parseInternal( String xml, boolean namespaceAware)
            throws ParserConfigurationException, SAXException, IOException {
    ...
    private static Document parseInternal(
             String xml, boolean namespaceAware,  List<String> parseErrors)
            throws ParserConfigurationException, IOException {
    ...
    private static void parseInternal(
             String xml, boolean namespaceAware,  DefaultHandler handler)
